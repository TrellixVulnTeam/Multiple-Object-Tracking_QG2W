...
do
if [ ! -f /home/stevenzc3/flow-30/${s}.npy ]; then
    python src/flow_seg.py --dataset_dir=/mnt/disks/tensorflow-disk/video_distillation/ --max_frames=30000 --training_stride=8 --sequence=${s} --stats_path=/home/stevenzc3/flow-30/${s}.npy -sequence_limit=2 --start_frame=0 --height=1080 --width=1920
fi
done
